	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'Networking', //Will appear in the data and in the default feedback message.
				title : {
			...
			category2 :	{
				name : 'No networking', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'No networking'}, //Name of the category presented in the task.
					css : {color:'#336600','font-size':'1.8em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
			...
			'Presione otra tecla para continuar.<p/>',
			...
			finalText : 'Presione espacio para continuar a la siguiente tarea', 
			finalTouchText : 'Toque el área verde inferior para continuar a la siguiente tarea',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Presione la tecla <b>E</b> con la mano izquierda para los ítems que pertenezcan a la categoría <font color="#0000ff">leftAttribute.</font>' +
				'<br/>Presione la tecla <b>I</b> con la mano derecha para los ítems que pertenezcan a la categoría <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'Los ítems aparecerán de uno en uno.<br/><br/>',
				'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. ' +
				'Presione la otra tecla para continuar.<br/>' +
				'<u>Vaya tan rápido como pueda</u>, intentando no cometer errores.<br/><br/></p>'+
				'<p align="center">Presione la <b>barra espaciadora</b> para empezar.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Use la mano izquierda sobre el área verde a la <b>izquierda</b> para los ítems que pertenezcan a la categoría <font color="#0000ff">leftAttribute</font>.<br/>',
						'Use la mano derecha sobre el área verde a la <b>derecha</b> para los ítems que pertenezcan a la categoría <font color="#0000ff">rightAttribute</font>.<br/>',
						'Los ítems aparecerán de uno en uno.<br/>',
						'<br/>',
						'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado de la pantalla. <u>Vaya tan rápido como pueda</u>, intentando no cometer errores.',
					'</p>',
					'<p align="center">Toque el área verde <b>inferior</b> para empezar.</p>',
				'</div>'
			].join('\n'),
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Presione la tecla <b>E</b> con la mano izquierda para los ítems que pertenezcan a la categoría <font color="#336600">leftCategory</font>. ' +
				'<br/>Presione la tecla <b>I</b> con la mano derecha para los ítems que pertenezcan a la categoría <font color="#336600">rightCategory</font>.<br/>' +
				'Los ítems aparecerán de uno en uno.<br/><br/>',
				'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. ' +
				'Presione la otra tecla para continuar.<br/>' +
				'<u>Vaya tan rápido como pueda</u>, intentando no cometer errores.<br/><br/></p>'+
			...
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Use la mano izquierda sobre el área verde a la <b>izquierda</b> para los ítems que pertenezcan a la categoría <font color="#336600">leftCategory</font>.<br/>',
						'Use la mano derecha sobre el área verde a la <b>derecha</b> para los ítems que pertenezcan a la categoría <font color="#336600">rightCategory</font>.<br/>',
						'Los ítems aparecerán de uno en uno.<br/>',
						'<br/>',
						'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado de la pantalla. <u>Vaya tan rápido como pueda</u>, intentando no cometer errores.',
					'</p>',
			...
			instFirstCombined : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'Use la tecla <b>E</b> para <font color="#336600">leftCategory</font> y para <font color="#0000ff">leftAttribute</font>.<br/>' +
				'Use la tecla <b>I</b> para <font color="#336600">rightCategory</font> y para  <font color="#0000ff">rightAttribute</font>.<br/>' +
				'Cada ítem pertenece a una sola categoría.<br/><br/>' +
				'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. ' +
				'Presione la otra tecla para continuar.<br/>' + 
				'<u>Vay tan rápido como pueda</u>, intentando no cometer errores.<br/><br/></p>' +
				'<p align="center">Presione la <b>barra espaciadora</b> para empezar.</font></p></div>',
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Use la mano izquierda sobre el área verde a la <b>izquierda</b> para los ítems <font color="#336600">leftCategory</font> y <font color="#0000ff">leftAttribute</font>.</br>',
						'Use la mano derecha sobre el área verde a la <b>derecha</b> para los ítems <font color="#336600">rightCategory</font> y <font color="#0000ff">rightAttribute</font>.</br>',
							'Si comete un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. Toque el otro área de la pantalla. <u>Vaya tan rápido como pueda</u>, intentando no cometer errores.</br>',
						'</p>',
						'<p align="center">Toque el área verde <b>inferior</b> para empezar.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'Use la mano derecha sobre el área verde a la <b>derecha</b> para los ítems <font color="#336600">rightCategory</font> y <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>Vaya tan rápido como pueda</u>, intentando no cometer errores.<br/>',
					'</p>',
					'<p align="center">Toque el área verde <b>inferior</b> para empezar.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'Use la mano izquierda sobre la tecla <b>E</b> para <font color="#336600">leftCategory</font>.<br/>' +
				'Use la mano derecha sobre la tecla <b>I</b> para <font color="#336600">rightCategory</font>.<br/><br/>' +
				'<u>Vaya tan rápido como pueda</u>, intentando no cometer errores.<br/><br/></p>' +
				'<p align="center">Presione la <b>barra espaciadora</b> para empezar.</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Atención, las etiquetas han cambiado de posición<br/>',
							'Use la mano izquierda sobre el área verde a la <b>izquierda</b> para los ítems <font color="#336600">leftCategory</font>.<br/>',
							'Use la mano derecha sobre el área verde a la <b>derecha</b> para los ítems <font color="#336600">rightCategory</font>.<br/>',
							'Los ítems aparecerán de uno en uno.',
							'<br/>',
							'Si cometes un error, aparecerá una letra <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado de la pantalla. <u>Vaya tan rápido como pueda</u>, intentando no cometer errores.<br/>',
						'</p>',
						'<p align="center">Toque el área verde <b>inferior</b> para empezar.</p>',
				'</div>'
			].join('\n'),
			...
			fb_strong_Att1WithCatA_Att2WithCatB : 'Sus respuestas sugieren una fuerte preferencia implícita por categoryB sobre categoryA.',
			fb_moderate_Att1WithCatA_Att2WithCatB : 'Sus respuestas sugieren una moderada preferencia implícita por categoryB sobre categoryA.',
			fb_slight_Att1WithCatA_Att2WithCatB : 'Sus respuestas sugieren una ligera preferencia implícita por categoryB sobre categoryA.',
			fb_equal_CatAvsCatB : 'Sus respuestas sugieren que no tiene preferencia implícita entre categoryA y categoryB.',

			//Error messages in the feedback
			manyErrors: 'Hubo demasiados erroes para determinar un resultado.',
