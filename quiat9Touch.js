	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			finalTouchText : 'Toque el área verde para continuar a la siguiente actividad',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'<u>Intente ir rápido</u>, pero evitando errores.<br/><br/></p>'+
			...
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Toque el área verde de la <b>izquierda</b> si el ítem pertenece a la categoría <font color="#0000ff">leftAttribute</font>.<br/>',
						'Toque el área verde de la <b>derecha</b>  si el ítem pertenece a la categoría <font color="#0000ff">rightAttribute</font>.<br/>',
						'Los ítems aparecerán de uno en uno.<br/>',
						'<br/>',
						'Si se equivoca, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque en el otro lado. <u>Intente ir rápido</u>, pero evitando errores.',
					'</p>',
			...
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'Toque el área verde de la <b>izquierda</b> si el ítem pertenece a la categoría <font color="#336600">leftCategory</font>.<br/>',
						'Toque el área verde de la <b>derecha</b>  si el ítem pertenece a la categoría <font color="#336600">rightCategory</font>.<br/>',
						'Los ítems aparecerán de uno en uno.<br/>',
						'<br/>',
						'Si se equivoca, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Intente ir rápido</u>, pero evitando errores.',
					'</p>',
			...
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'Toque el área verde de la <b>izquierda</b> para <font color="#336600">leftCategory</font> y para <font color="#0000ff">leftAttribute</font>.</br>',
						'Toque el área verde de la <b>derecha</b> para <font color="#336600">rightCategory</font> y para <font color="#0000ff">rightAttribute</font>.</br>',
						'Si se equivoca, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque al otro lado. <u>Intente ir rápido</u>, evitando cometer errores.</br>',
						'</p>',
						'<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'Toque el área verde de la <b>Derecha</b> para <font color="#336600">rightCategory</font> y para <font color="#0000ff">rightAttribute</font>.<br/>',
					'<br/>',
					'<u>Intente ir rápido</u>, evitando cometer errores.<br/>',
					'</p>',
					'<p align="center">Toque en el área verde <b>inferior</b> para empezar.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategoriesTouch: [
				...
				'Toque el área verde de la <b>Izquierda</b> para los ítems de <font color="#336600">leftCategory</font>.<br/>',
				'Toque el área verde de la <b>Derecha</b> para los ítems de <font color="#336600">rightCategory</font>.<br/>',
				'Los ítems aparecerán de uno en uno.',
				'<br/>',
				'Se se equivoca, aparecerá una <font color="#ff0000"><b>X</b></font> roja. Toque el otro lado. <u>Intente ir rápido</u>, evitando cometer errores.<br/>',
				'</p>',
				'<p align="center">Toque el área verde <b>inferior</b> para comenzar.</p>',
				'</div>'
			].join('\n'),
			...
			preDebriefingTouchText : 'Toque el área verde inferior para ver los resultados', //Touch version for the text in the trial that comes before showing the debriefing.
			...
			debriefingTextBottom : 'Estos resultados no son una evaluación definitiva de sus actitudes. Pulse espacio.', //Will be shown below the feedback text. 
            debriefingTextBottomTouch : 'Estos resultados no son una evaluación definitiva de sus actitudes. Toque el área verde para continar.',
		...
		*/
		...
		API.addStimulusSets({
			...
			instructions: [
				{css:{'font-size':'1.1em',color:'black', lineHeight:1.2}, nolog:true, 
